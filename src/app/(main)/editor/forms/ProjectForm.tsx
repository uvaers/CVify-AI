...
function ProjectItem({ id, form, index, remove }: ProjectItemProps) {
  ...
  return (
    ...
    >
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input {...field} placeholder="React, Node.js, PostgreSQL..." />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
      ...
      <FormDescription>
        Leave <span className="font-semibold">end date</span> empty if this is an ongoing project.
      </FormDescription>
      <FormField
        control={form.control}
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Textarea 
                {...field} 
                placeholder="Describe the project, its goals, and your role in it"
              />
            </FormControl>
            <FormMessage />
          </FormItem>
